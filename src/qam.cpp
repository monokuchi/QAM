...
int main()
{
    ...
    float sample_rate = 10000; // Sample rate in Hz
    ...
    std::vector<float> I_carrier_signal = generateSin(freq, 5000, sample_rate);
    std::vector<float> Q_carrier_signal = generateCos(freq, 5000, sample_rate);
